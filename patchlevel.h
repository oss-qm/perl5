...
static const char * const local_patches[] = {
	...
	,"DEBPKG:fixes/arm-alignment - http://bugs.debian.org/289884 Prevent gcc from optimizing the alignment test away on armel"
	,"DEBPKG:fixes/fcgi-test - Fix a failure in CGI/t/fast.t when FCGI is installed"
	,"DEBPKG:patchlevel - http://bugs.debian.org/567489 List packaged patches for 5.10.1-13 in patchlevel.h"
	,NULL
};

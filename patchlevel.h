...
static const char * const local_patches[] = {
	...
	,"DEBPKG:fixes/term-readline-gnu-conflict - [5dec12c] Fix a test failure in perl5db.t when Term::ReadLine::Gnu is installed"
	,"DEBPKG:patchlevel - http://bugs.debian.org/567489 List packaged patches for 5.12.0-2 in patchlevel.h"
	,NULL
};
